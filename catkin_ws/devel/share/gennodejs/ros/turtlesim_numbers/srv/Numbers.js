...
// (in-package turtlesim_numbers.srv)
...
class NumbersRequest {
  ...
  static serialize(obj, buffer, bufferOffset) {
    // Serializes a message object of type NumbersRequest
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    //deserializes a message object of type NumbersRequest
    let len;
    let data = new NumbersRequest(null);
  ...
  static Resolve(msg) {
    ...
    const resolved = new NumbersRequest(null);
    if (msg.a !== undefined) {
      resolved.a = msg.a;
    }
    else {
...
class NumbersResponse {
  ...
  static serialize(obj, buffer, bufferOffset) {
    // Serializes a message object of type NumbersResponse
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    //deserializes a message object of type NumbersResponse
    let len;
    let data = new NumbersResponse(null);
  ...
  static Resolve(msg) {
    ...
    const resolved = new NumbersResponse(null);
...
module.exports = {
  ...
  datatype() { return 'turtlesim_numbers/Numbers'; }
};
